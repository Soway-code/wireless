...
struct sockaddr_in server_addr;//frank
int sal_init(void)
{
    int cn;
...
//AT+QIOPEN=1,0,"TCP","121.41.12.44",6800,14,0  iot.eclipse.org:1883
//#define SAL_INTERNET_HOST "47.100.63.174"//"121.41.12.44"// "southbound.quectel.com"// "link.rt-thread.org"
////"southbound.quectel.com",1883  ip 47.100.63.174 1883
//#define SW_SAL_INTERNET_IP  "47.100.63.174"//"121.41.12.44"// "47.100.63.174"  //6800 // frank
//
//#define SAL_INTERNET_PORT   1883//8164//6800//1883// 8101  
#if (Swy_tcp == 1)
#define  SW_SAL_INTERNET_IP "121.41.12.44" //"220.180.239.212"
#define  SAL_INTERNET_PORT 6800  //8164 
#define   protocol_type  SOCK_STREAM
#elif (Swy_udp == 1) //udp  192.53.100.53,5683 121.41.12.44,7000 
#define  SW_SAL_INTERNET_IP "121.41.12.44"  //"192.53.100.53" 
#define  SAL_INTERNET_PORT   7000
#define   protocol_type  SOCK_DGRAM
#elif (Swy_mqtt == 1) //mqtt  "southbound.quectel.com" "47.100.63.174" 1883
#define  SW_SAL_INTERNET_IP "47.100.63.174" 
#define  SAL_INTERNET_PORT 1883
#define   protocol_type  SOCK_STREAM
#endif
...
#define SAL_INTERNET_DATE_LEN  16
 ...
 {
    int index, sockfd = -1, result = 0,checktcpcon=0;
   ...
   host = (struct hostent *) pf->netdb_ops->gethostbyname(SW_SAL_INTERNET_IP);
		if (host == RT_NULL)
    {
        result = -RT_ERROR;
        goto __exit;
    ...
    skt_ops = pf->skt_ops;    //  ori  SOCK_STREAM SOCK_DGRAM frank
    if ((sockfd = skt_ops->socket(AF_INET, protocol_type, 0)) < 0)
    {
        result = -RT_ERROR;
        goto __exit;
    }
		rt_kprintf("sal_socket sock %d\n",sockfd);

    server_addr.sin_family = AF_INET;
    server_addr.sin_port = htons(SAL_INTERNET_PORT);  //frank
    //server_addr.sin_addr = *((struct in_addr *)host->h_addr);
		server_addr.sin_addr.s_addr=inet_addr(SW_SAL_INTERNET_IP);
 ...
 #endif
	  checktcpcon=at_connect(sockfd, (struct sockaddr *)&server_addr, sizeof(struct sockaddr));
	  rt_kprintf("tcpConnect check%d\n",checktcpcon);
 #ifndef Swy_mqtt
...
__exit:
 rt_kprintf("check_netdev_internet_up_work \n");
#ifndef Swy_mqtt
    if (result >= 0) // frank
    {
...
int sal_closesocket(int socket)
{
    ...
    else
    {
		...
		//server_addr.socket_state = YX_NET_STATUS_CONN_STOP;
